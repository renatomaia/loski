...
do
	...
	local dgm = assert(testutils.testcreatesocket("datagram"))
	local con = assert(testutils.testcreatesocket("stream"))
...
do
	...
	weak.s1 = assert(testutils.testcreatesocket("stream"))
	weak.s2 = assert(testutils.testcreatesocket("stream"))
